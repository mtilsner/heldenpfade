...
\begin{enemyprofile}{Krähe}
  ...
  \begin{enemycolumns}
    ...
    \begin{enemysectionbox}{Verhalten}
      Beginnt die Krähe ihre Runde unmittelbar bei einem Helden, setzt sie \textbf{Schnabelhieb} ein.

      Andernfalls greift sie den nächstgelegenen Helden mit einem \textbf{Vorbeiflug} an.
    \end{enemysectionbox}
