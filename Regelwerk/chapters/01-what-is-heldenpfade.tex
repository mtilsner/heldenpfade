...
\subsection*{Heldenwürfel}

Der weiße Heldenwürfel \heroDie{} ist der persönliche Würfel eines Helden.

Jeder Held besitzt genau einen Heldenwürfel.

\subsection*{Probenwürfel}

Für Proben werden zwei verschiedene Würfelarten verwendet:

\begin{itemize}
  \item grüne Attributswürfel \greenDie{},
  \item blaue Fertigkeitswürfel \blueDie{}.
\end{itemize}

Welche dieser Würfel bei einer Probe verwendet werden, hängt von den Fähigkeiten des Helden ab.

\subsection*{Schadenswürfel}

Für Schaden werden drei verschiedene Würfelarten verwendet:

\begin{itemize}
  \item orangene Schadenswürfel \orangeDmgDie{} für leichten Schaden,
  \item rote Schadenswürfel \redDmgDie{} für mittleren Schaden,
  \item schwarze Schadenswürfel \blackDmgDie{} für schweren Schaden.
\end{itemize}

Je gefährlicher ein Angriff ist, desto stärkere Schadenswürfel können zum Einsatz kommen.
