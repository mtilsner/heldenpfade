...
Jede Karte besitzt eine Vorder- und eine Rückseite. Die Vorderseite zeigt die Karte im \textbf{bereiten} Zustand. Auf der Rückseite ist die Illustration zur besseren Erkennbarkeit in Schwarz-Weiß dargestellt; sie zeigt die Karte im \textbf{erschöpften} Zustand.

Das Symbol \exhaust{} bedeutet immer: \textbf{Drehe diese Karte um.}

Wird eine bereite Karte von ihrer Vorderseite auf ihre Rückseite gedreht, wird sie \textbf{erschöpft}. Wird eine erschöpfte Karte von ihrer Rückseite auf ihre Vorderseite gedreht, wird sie \textbf{bereit gemacht}.

Es gelten ausschließlich die Angaben, Werte und Effekte der aktuell sichtbaren Kartenseite. Angaben der verdeckten Seite gelten nicht.

\begin{kurzregel}[title=Bereite und erschöpfte Karten]
\textbf{Vorderseite:} Die Karte ist bereit.\newline
\textbf{Rückseite:} Die Karte ist erschöpft.\newline
\exhaust{}: Drehe die Karte um.
\end{kurzregel}
