...
\begin{enumerate}
  ...
  \item Erhaltene Schadenswürfel werfen und Schaden addieren.
  \item Gekaufte Kampfeffekte sowie \armor{} und \armorPierce{} anwenden.
  \item Verbleibenden Schaden von den Lebenspunkten abziehen.
  \item Zusätzliche Folgen der Angriffsoption abhandeln.
\end{enumerate}
\end{kurzregel}
...
Eine Kaufoption nennt ihre Kosten in \star{} und den dafür erhaltenen Effekt. Der Angreifer darf seine erzielten \star{} in beliebiger Kombination für die Kaufoptionen der gewählten Angriffsoption ausgeben. Mit $\infty$ gekennzeichnete Kaufoptionen dürfen beliebig oft, mit 1$\times$ gekennzeichnete Kaufoptionen höchstens einmal pro Angriff gekauft werden. Nicht ausgegebene \star{} verfallen.

Alle durch Kaufoptionen erhaltenen Schadenswürfel werden zu einem gemeinsamen Schadenspool zusammengefügt. Sie werden gemeinsam geworfen und ihre Ergebnisse anschließend addiert. Kaufoptionen können statt Schadenswürfeln oder zusätzlich zu ihnen Kampfeffekte verleihen.

\begin{kurzregel}[title=Schaden bestimmen]
\begin{enumerate}
  \item Erzielte \star{} für Kaufoptionen ausgeben.
  \item Alle erhaltenen Schadenswürfel zu einem Schadenspool zusammenfügen.
  \item Schadenswürfel werfen und gewürfelten Schaden addieren.
  \item Gekaufte Kampfeffekte anwenden.
  \item Schutz durch \armor{} abziehen.
  \item Verbleibenden Schaden als Verlust von Lebenspunkten anwenden.
\end{enumerate}
\end{kurzregel}

\begin{beispiel}[title=Beispiel: Schadenswürfel kaufen]
Ein Schwert besitzt die Kaufoptionen $\infty$\;\star{} $\rightarrow$ \orangeDmgDie{} und 1$\times$\;3\star{} $\rightarrow$ \orangeDmgDie{}\orangeDmgDie{}\orangeDmgDie{}\orangeDmgDie{}. Erzielt ein Held 3\star{}, kann er die erste Kaufoption dreimal kaufen und 3\orangeDmgDie{} erhalten. Er kann stattdessen die zweite Kaufoption einmal kaufen und erhält 4\orangeDmgDie{}.
\end{beispiel}

\begin{beispiel}[title=Beispiel: Verschiedene Kaufoptionen kombinieren]
Kiera erzielt mit ihrem Zahnschwert 2\star{}. Sie kann für beide \star{} zweimal die unbegrenzte Kaufoption erwerben und erhält 4\orangeDmgDie{}. Alternativ kauft sie einmal 2\orangeDmgDie{} und einmal die auf 1$\times$ begrenzte Kaufoption für 2\redDmgDie{}. In diesem Fall besteht ihr gemeinsamer Schadenspool aus 2\orangeDmgDie{} und 2\redDmgDie{}.
\end{beispiel}

Das \textbf{Schild-Symbol (\armor)} beschreibt Schutz durch Rüstung, Schilde, Talente oder andere Effekte. Jedes \armor{} verhindert 1 Schaden. \textbf{Rüstungsdurchdringung (\armorPierce)} ignoriert die angegebene Anzahl an Schild-Symbolen des Ziels, unabhängig von ihrer Quelle.

\begin{kurzregel}[title=Schild-Symbole und Rüstungsdurchdringung]
...
\begin{enumerate}
  ...
  \item \textbf{Kaufoptionen erwerben:} Kiera kauft für 1\star{} zwei \orangeDmgDie{} und für den zweiten \star{} einmalig zwei \redDmgDie{}.
  \item \textbf{Schaden würfeln:} Ihr Schadenspool aus 2\orangeDmgDie{} und 2\redDmgDie{} verursacht zusammen 6 Schaden.
  \item \textbf{Schutz anwenden:} Der Gegner besitzt 2\armor{} und verhindert damit 2 Schaden.
  \item \textbf{Lebenspunkte verlieren:} Der Gegner verliert die verbleibenden 4 Lebenspunkte.
\end{enumerate}
\end{beispiel}
