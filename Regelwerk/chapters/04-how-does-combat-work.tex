...
Ein Angriff benötigt eine \standardAction. Der Held wählt eine Waffe oder einen Angriffszauber. Die gewählte Angriffsoption bestimmt die Angriffsfertigkeit, die Reichweite, die Schadensformel und mögliche besondere Effekte.

\begin{kurzregel}[title=Einen Angriff durchführen]
\begin{enumerate}
  \item Waffe oder Angriffszauber wählen.
...
Ein am Boden liegender Held hat Nachteil auf seine Ausweichprobe. Kann er aufgrund seiner Ausrüstung oder Talente nicht ausweichen, entfällt die Probe vollständig.
...
\begin{enumerate}
  \item \textbf{Angriffsoption wählen:} Kiera greift einen benachbarten Gegner mit ihrem Zahnschwert an.
