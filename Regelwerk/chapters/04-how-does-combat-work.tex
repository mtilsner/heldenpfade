...
Eine \textbf{Reaktion} ist eine \freeAction{}, die ein Held außerhalb seines eigenen Zuges ausführt. Eine Reaktion ist nur möglich, wenn ein Talent oder eine andere Regel einen fest definierten Auslöser nennt und dieser Auslöser gerade eingetreten ist. Die Reaktion wird unmittelbar nach ihrem Auslöser abgehandelt, bevor das Spiel fortgesetzt wird.
...
\begin{enumerate}
  ...
  \item Bei mindestens einem \star{} Sterne gemäß der Angriffsoption ausgeben.
  ...
  \item Ausgelöste Kampfeffekte und zusätzliche Folgen zu ihrem jeweils angegebenen Zeitpunkt abhandeln.
\end{enumerate}
\end{kurzregel}
...
\subsection{Sterne ausgeben und Schaden}
...
Jede aufgeführte Zeile nennt ihre Kosten in \star{} und den dafür erhaltenen Effekt. Jede Zeile der gewählten Angriffsoption darf pro Angriff höchstens einmal genutzt werden. Der Angreifer darf mehrere unterschiedliche Zeilen in beliebiger Kombination nutzen, solange er die angegebenen \star{} ausgibt und alle Voraussetzungen erfüllt.

Nachdem alle gewünschten Zeilen genutzt wurden, dürfen verbleibende \star{} bereits erhaltene Schadenswürfel verbessern. Jeder ausgegebene \star{} verbessert einen Würfel um eine Stufe: \orangeDmgDie{} wird zu \redDmgDie{}, \redDmgDie{} wird zu \blackDmgDie{}. Derselbe Würfel darf mehrfach verbessert werden; \blackDmgDie{} können nicht weiter verbessert werden. Danach verfallen noch übrige \star{}.

Alle erhaltenen und verbesserten Schadenswürfel bilden einen gemeinsamen Schadenspool. Sie werden gemeinsam geworfen und ihre Ergebnisse anschließend addiert. Durch das Ausgeben von \star{} können statt Schadenswürfeln oder zusätzlich zu ihnen Kampfeffekte ausgelöst werden.
...
\begin{beispiel}[title=Beispiel: Sterne für Schadenswürfel ausgeben und Würfel verbessern]
Beim Schwert können 2\star{} für 2\orangeDmgDie{} und 3\star{} für 3\orangeDmgDie{} ausgegeben werden. Mit 6\star{} nutzt ein Held beide Zeilen je einmal und gibt dafür insgesamt 5\star{} aus. Mit dem verbleibenden \star{} verbessert er einen der fünf orangen Würfel zu einem roten Würfel. Sein Schadenspool besteht aus 1\redDmgDie{} und 4\orangeDmgDie{}.
\end{beispiel}

\begin{beispiel}[title=Beispiel: Schaden und Kampfeffekt kombinieren]
Bei einer Axt können unter anderem 2\star{} für 1\redDmgDie{} und weitere 2\star{} für \effectArmorBreak{} 2 ausgegeben werden. Mit 4\star{} kann ein Held beide Zeilen nutzen. Der Angriff verursacht Schaden mit 1\redDmgDie{} und erhält zusätzlich 2 Rüstungsbruch. Beide Zeilen können bei diesem Angriff nicht erneut genutzt werden.
\end{beispiel}
...
Lebenspunkte können niemals unter 0 sinken. Heilung kann die aktuellen Lebenspunkte niemals über das Lebenspunkte-Maximum der Figur erhöhen.
...
\begin{enumerate}
  ...
  \item \textbf{Sterne ausgeben:} Kiera gibt 2\star{} für zwei \redDmgDie{} und 3\star{} für drei \orangeDmgDie{} aus.
