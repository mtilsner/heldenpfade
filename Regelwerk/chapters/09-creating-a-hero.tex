...
Kiera soll mutig, aufmerksam und widerstandsfähig sein. Sie investiert jeweils zwei Würfel in MUT, INT und KON sowie jeweils einen Würfel in GEW und KRA.

Damit besitzt sie MUT 2, KLU 0, INT 2, CHA 0, FIN 0, GEW 1, KON 2 und KRA 1. Insgesamt hat sie alle acht Attributswürfel verteilt.
\end{beispiel}

\subsection{Fertigkeiten verteilen}

Zu Beginn der Heldenerschaffung erhält der Spieler zwölf blaue Fertigkeitswürfel, die frei auf die Fertigkeiten verteilt werden.

\begin{kurzregel}[title=Fertigkeiten verteilen]
Verteile zwölf blaue Fertigkeitswürfel auf die Fertigkeiten. Keine Fertigkeit darf zu Beginn mehr als zwei Würfel besitzen. Fertigkeiten dürfen auch keinen Würfel besitzen.
\end{kurzregel}
...
\textbf{Attribute:} Kiera verteilt ihre acht Attributswürfel auf MUT 2, INT 2, GEW 1, KON 2 und KRA 1. KLU, CHA und FIN bleiben auf 0.

\textbf{Fertigkeiten:} Sie verteilt ihre zwölf Fertigkeitswürfel auf Schlagen 2, Zaubern 2, Turnen 1, Schleichen 2, Suchen 1, Nachdenken 1, Natur kennen 1, Heilen 1 und Überzeugen 1. Alle übrigen Fertigkeiten bleiben auf 0.

\textbf{Abgeleitete Werte:} Mit KON 2 besitzt Kiera $14 + 2 \times 2 = 18$ Lebenspunkte. Mit CHA 0 besitzt sie zunächst 0 Mana.

\textbf{Starttalent:} Kiera wählt \emph{Magiebegabt}. Das Talent erhöht ihren Manavorrat um 6, sodass sie mit 6 Mana beginnt.

\textbf{Startzauber:} Kiera erlernt \emph{Eisblitz} für 1 Mana, \emph{Weißer Speer} für 1 Mana, \emph{Zielscheibe} für 2 Mana und \emph{Herzschlag spüren} für 2 Mana. Die Summe ihrer Manakosten entspricht genau ihrem Manavorrat von 6.

\textbf{Startausrüstung:} Gemeinsam mit der Spielleitung wählt Kiera einen einfachen Speer, robuste Reisekleidung, einen Rucksack und übliche Reiseausrüstung. Diese Gegenstände passen zu ihrer bisherigen Arbeit als Botin und zu einem neuen Abenteurer.
