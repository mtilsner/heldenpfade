...
Die Rollen und ihre Schwerpunkte werden in \chapterref{chap:talents} beschrieben.
...
Die Fertigkeiten bestimmen, in welchen Bereichen ein Held bereits Erfahrung gesammelt hat. Eine Übersicht aller Fertigkeiten befindet sich in \chapterref{chap:hero-basics}. Die Regeln für Fertigkeitsproben stehen in \chapterref{chap:checks}.
...
Talente und andere Effekte können diese Werte anschließend verändern. Die genauen Regeln für Lebenspunkte und Mana stehen in \chapterref{chap:hero-basics}.
...
Das Starttalent gilt als erlernt und trainiert. Die Regeln für Talente sowie die Bedeutung der Rollen stehen in \chapterref{chap:talents}.
...
Das Talent \emph{Magiebegabt} erhöht den Manavorrat des Helden um 6 Mana. Die Regeln für Zauber stehen in \chapterref{chap:magic}.
...
\textbf{Abgeleitete Werte:} Mit KON 1 besitzt Kiera $10 + 2 \times 1 = 12$ Lebenspunkte. Mit CHA 1 besitzt sie zunächst 2 Mana.
